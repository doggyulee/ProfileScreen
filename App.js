      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{alignSelf: "center"}}>
          ...
          <View style={styles.add}>
            <Ionicons name="ios-add" size={48} color="#DFDBCB" style={{marginTop: 6, marginLeft: 2}}></Ionicons>
          </View>
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statsBox, {borderColor: "#DFDBCB", borderLeftWidth: 2, borderRightWidth: 2}}>
            <Text style={styles.text, {fontSize: 24}}>43,124</Text>
          ...
          <View style={styles.recentItem}>
            ...
            <View style={{width: 250}}>
              <Text style={styles.text, {color: "#41444B", fontWeight:"300"}}>
                Started following <Text style={{fontWeight: "400"}}>
                Lucas Lee and <Text style={{ fontWeight: "400"}}>
                DesignIntoCode</Text>
                </Text>
              </Text>
            </View>
